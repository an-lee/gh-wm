...
func runCreatePullRequestReviewComment(ctx context.Context, tc *types.TaskContext, item ItemCreatePullRequestReviewComment) error {
...
func runReplyToPullRequestReviewComment(ctx context.Context, tc *types.TaskContext, item ItemReplyToPullRequestReviewComment) error {
	...
	_ = n // PR number validated for context; REST uses repo + comment_id only
